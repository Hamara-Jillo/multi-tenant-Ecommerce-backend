# Generated by Django 3.2 on 2025-05-20 02:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='store',
            name='dimension_unit',
            field=models.CharField(choices=[('cm', 'Centimeters (cm)'), ('in', 'Inches (in)')], default='cm', max_length=10, verbose_name='Dimension Unit'),
        ),
        migrations.AddField(
            model_name='store',
            name='is_primary_store',
            field=models.BooleanField(default=False, verbose_name='Is Primary Store'),
        ),
        migrations.AddField(
            model_name='store',
            name='legal_business_name',
            field=models.CharField(blank=True, max_length=255, verbose_name='Legal Business Name'),
        ),
        migrations.AddField(
            model_name='store',
            name='order_id_prefix',
            field=models.CharField(blank=True, max_length=10, verbose_name='Order ID Prefix'),
        ),
        migrations.AddField(
            model_name='store',
            name='organization_id',
            field=models.CharField(blank=True, max_length=100, verbose_name='Organization ID'),
        ),
        migrations.AddField(
            model_name='store',
        ...
        migrations.AddField(
            model_name='store',
            name='primary_domain',
            field=models.CharField(blank=True, max_length=255, validators=[django.core.validators.URLValidator()], verbose_name='Primary Domain'),
        ),
        migrations.AddField(
            model_name='store',
            name='state_province',
        ...
        migrations.AddField(
            model_name='store',
            name='store_password',
            field=models.CharField(blank=True, max_length=100, verbose_name='Store Password'),
        ),
        migrations.AddField(
            model_name='store',
            name='timezone',
        ...
        migrations.AddField(
            model_name='store',
            name='weight_unit',
            field=models.CharField(choices=[('kg', 'Kilograms (kg)'), ('lb', 'Pounds (lb)')], default='kg', max_length=10, verbose_name='Weight Unit'),
        ),
