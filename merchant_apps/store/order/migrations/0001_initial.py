    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': [('multi_store_order', 'Can access orders across stores')],
                'abstract': False,
            },
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='shippingevent',
            name='store',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='store_meta.store'),
        ),
        migrations.CreateModel(
