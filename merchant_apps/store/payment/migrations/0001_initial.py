    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('store', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='payment_source_types', to='store_meta.store')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='source',
            name='store',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='payment_sources', to='store_meta.store'),
        ),
    ]
